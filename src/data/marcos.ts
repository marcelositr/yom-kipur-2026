...
export const marcos: Marco[] = [
  ...
  },
  {
    ...
    calendarNote: '9 Tishrei 5787 começa ao pôr do sol de sábado, 19 de setembro. A publicação está prevista após o término de Shabbat Shuvah, já dentro de 9 Tishrei. O dia civil de domingo, 20 de setembro, é Erev Yom Kipur. Yom Kipur começa ao pôr do sol desse domingo e segue até a noite de segunda-feira, 21 de setembro.',
